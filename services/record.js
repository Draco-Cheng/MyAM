...
var _delRecord = function(data, callback) {
  ...
  _checkDB.then(function(data) {
    ...
    .then(function(data) {
      return controller.dbController.delRecordTypeMap(data); })
    .then(function(data) {
      return controller.dbController.delRecord(data); })
    .then(function(data) {
...
var _setRecord = function(data, callback) {
  ...
  _checkDB.then(function(data) {
      return controller.dbController.connectDB(data); })
    .then(function(data) {
      return controller.dbController.setRecord(data); })
    .then(function(data) {
      return controller.dbController.closeDB(data); })
    .then(function(data) {
      callback(null, data);
...
var _setRecordTypes = function(data, callback) {
  ...
  _checkDB.then(function(data) {
      return controller.dbController.connectDB(data); })
    .then(function(data) {
      return controller.dbController.getRecordTypeMap(data); })
    .then(function(data) {
      //parse what we need to add and what have to delete
      data.tids_add = data.tids_json.map(function(i) {
        return parseInt(i) })
      data.tids_del = [];
      ...
      data.tids_add = data.tids_add.filter(function(i) {
        return i !== undefined });
