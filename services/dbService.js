...
exports.dbList = async function(data) {
  try {
...
exports.breackPointDbList = async function(data) {
  try {
    let _meta = data['meta'];
    let _responseObj = data['responseObj'];
...
exports.checkBackUp = async function(data) {
  try {
...
var renameBackupFolder = function(uid, dbName, newDbName) {
...
var deleteRenameBackupFolder = function(uid, dbName) {
  let _backupFolderPath = config.backupFolder + 'users/' + uid + '/';
  const _data = {
    meta: {
      source: _backupFolderPath + dbName,
...
var makeBreakPointInBackupFolder = async function(uid, dbName, fileName) {
  try {
...
exports.renameDb = async function(data) {
  try {
...
exports.delDB = async function(data) {
  try {
...
exports.delBreakponitDb = async function(data) {
  try {
...
exports.checkPathExist = function(data) {
