...
(function() {
  ...
  _func.buildTypeMaps = function(data, callback, forceUpdate) {
    ...
    _func.getType(data, function() { _getTypeFlag = true;
      _parse(); }, forceUpdate);
    _func.getTypeMaps(data, function() { _getTypeMapsFlag = true;
      _parse(); }, forceUpdate);
  }
  ...
  _func.createFlatTypeMaps = function(data, callback, forceUpdate) {
    ...
    _func.getType(data, function(response) { _type = response;
      _parse(); }, forceUpdate);
    _func.getTypeMaps(data, function(response) { _typeMaps = response;
      _parse(); }, forceUpdate);
  };
